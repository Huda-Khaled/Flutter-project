...
class WebViewScreencopyy extends StatefulWidget {
  final VoidCallback onChangeNavigation;
  const WebViewScreencopyy({required this.onChangeNavigation});
  @override
  State<WebViewScreencopyy> createState() => _WebViewScreenState();
}

class _WebViewScreenState extends State<WebViewScreencopyy> {
                  ...
                  onPageFinished: (finish) async {
                    ...
                    try {
                      if (((await Provider.of<WebviewProv>(
                            context,
                            listen: false,
                          ).webViewControllerCopyy?.canGoBack()) ??
                          false)) {
                        setState(() {
                          _isBack = true;
                        });
  ...
  Widget build(BuildContext context) {
    return Selector<WebviewProv, WebViewController?>(
      selector: (_, prov) => prov.webViewControllerCopyy,
      builder: (_, ctrl, ___) {
        return Scaffold(
          key: _key,
          endDrawer: Drawer(
            ...
            child: ListView(
              children: [
                ...
                const Divider(color: Color(0xFF29617f)),
                ListTile(
                  trailing: const Icon(
                ...
                ListTile(
                  ...
                  onTap: () {
                    Share.share(
                      ...
                      'قم بتحميل تطبيق  سلم الرواتب الرابط https://www.freelancer.com/',
                      subject: ' قم بتحميل تطبيق سلم الرواتب',
                    );
                ...
                //   height: 0,
                // ),
                // Image.network('https://www.freelancer.com/'),
                // Text(
                //   'Hadi Asiri © تطوير',
                //   textAlign: TextAlign.center,
                //   style: TextStyle(
            ...
            leading: Row(
              ...
              children: [
                IconButton(
                  ...
                  icon: const Icon(Icons.telegram, color: Color(0xFF29617f)),
                  iconSize: 35,
                ),
                // IconButton(
                //   onPressed: () {
