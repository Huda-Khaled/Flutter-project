...
class WebViewScreencopyyyy extends StatefulWidget {
  ...
  const WebViewScreencopyyyy({required this.onChangeNavigation});
  @override
...
class _WebViewScreenState extends State<WebViewScreencopyyyy> {
  ...
  Widget build(BuildContext context) {
    return Selector<WebviewProv, WebViewController?>(
      selector: (_, prov) => prov.webViewControllerCopyyyy,
      builder: (_, ctrl, ___) {
        return Scaffold(
          key: _key,
          endDrawer: Drawer(
